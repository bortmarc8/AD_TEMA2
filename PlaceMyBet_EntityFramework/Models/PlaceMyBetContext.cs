...
namespace PlaceMyBet_EntityFramework.Models
{
    public class PlaceMyBetContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Evento>().HasData(new Evento(1, "Barça", "Madrid", "2020-12-16".AsDateTime().Date));
            modelBuilder.Entity<Mercado>().HasData(new Mercado(1, 1.5, 1.5, 2.5, 100, 50, 1));
            modelBuilder.Entity<Mercado>().HasData(new Mercado(2, 2.5, 1.5, 1.5, 100, 100, 1));
            modelBuilder.Entity<Mercado>().HasData(new Mercado(3, 3.5, 2.5, 1.5, 50, 100, 1));
